...
def _register_prompts(server: Any) -> None:
    ...
    def model_this_part(description: str, units: str = "mm") -> str:
        ...
        return (
            ...
            "4. Confirm the result with `measure_part`, and look at it with "
            "`capture_view` -- the checks passing is not a reason to skip the "
            "picture, and `iso` is the orientation that means what it says.\n"
